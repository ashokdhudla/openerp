...
openerp.real_estate = function (instance)
{   

  instance.web.form.widgets.add('location_map', 'instance.real_estate.Map');

  instance.real_estate.Map = instance.web.form.AbstractField.extend({
    ...
    set_value: function(value) {
      ...
      if(this.map != null & value != false) {
        var Partner = new instance.web.Model('real.estate.sales');
