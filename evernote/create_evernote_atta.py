...
class EvernoteUpload(object):
    ...
    def _connect_to_evernote(self, dev_token):
        ...
        try:
            ...
            user = self.user_store.getUser(dev_token)
...
#    dev_token = "S=s1:U=72d01:E=1479a33c4dd:C=140428298df:P=1cd:A=en-devtoken:V=2:H=f85f82d8927640558388d21d02819d7f"
#    p = EvernoteUpload(dev_token)
#    p.upload_to_notebook('report.pdf', 'boom')
