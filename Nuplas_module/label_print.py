...
class label_print(osv.osv):
    ...
    def onchange_model(self, cr, uid, ids, model_id):
        print "this onchange model is calling"
        model_list = ""
        if model_id:
    ...
    def create_action(self, cr, uid, ids, context=None):
        print "crete method...........................create_actionyesssss"
        vals = {}
    ...
    def unlink_action(self, cr, uid, ids, context=None):
        print "unlink method is working............nooooo"
        ir_values_obj = self.pool.get('ir.values')
        print "ir_values_obj",ir_values_obj
        act_window_obj = self.pool.get('ir.actions.act_window')
        print "act_window_obj",act_window_obj
